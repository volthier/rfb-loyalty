    ...
    describe('RfbLocation Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a RfbLocation', () => {
                service.create(new RfbLocation(null)).subscribe(received => {
            ...
            it('should update a RfbLocation', () => {
                service.update(new RfbLocation(123)).subscribe(received => {
            ...
            it('should return a RfbLocation', () => {
