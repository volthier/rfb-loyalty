    ...
    describe('RfbEventAttendance Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a RfbEventAttendance', () => {
                service.create(new RfbEventAttendance(null)).subscribe(received => {
            ...
            it('should update a RfbEventAttendance', () => {
                service.update(new RfbEventAttendance(123)).subscribe(received => {
            ...
            it('should return a RfbEventAttendance', () => {
            ...
            it('should return a list of RfbEventAttendance', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new RfbEventAttendance(123)]);
            });
